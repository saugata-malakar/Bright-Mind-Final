...
class Settings(BaseSettings):
    ...
    # Database
    DATABASE_URL: str = "postgresql://mediguide:mediguide123@localhost:5432/mediguide"
    DB_POOL_SIZE: int = 20
    ...
    ALLOWED_EXTENSIONS: List[str] = ["jpg", "jpeg", "png", "pdf", "dcm"]
    ...
    MEDICAL_KB_PATH: str = "./medical-kb"
